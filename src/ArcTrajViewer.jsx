...
export default function ArcTrajViewer() {
  ...
  return (
    ...
    <div className="flex flex-col min-h-[calc(100vh-1px)] w-[calc(100vw-1rem)] overflow-hidden font-sans">
      {/* 상단 헤더 */}
      ...
      <div className="flex flex-grow w-full">
        ...
        <div className="w-[28rem] h-screen overflow-y-auto bg-gray-900 text-white p-4 flex flex-col">
          <h2 className="text-lg font-semibold sticky top-0 z-10 bg-gray-900 py-3 border-b border-gray-700">📁 Tasks</h2>
          {loading ? (
